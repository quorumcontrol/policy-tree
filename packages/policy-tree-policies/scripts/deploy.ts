...
import HeavenTokenContract from './HeavenToken.json'
...
async function deployLocal() {
    ...
    const heavenToken = HeavenTokenContract.networks['33343733366']
    ...
    fs.writeFileSync('./lib/policies.json', Buffer.from(JSON.stringify({
        contracts: contracts,
        liquid: did,
    })))
